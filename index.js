...
const firstAnimalStartingWithLetterP = animalStrings.find((firstPAnimal) =>
  firstPAnimal.startsWith("p")
);

const indexOfGiraffe = animalStrings.findIndex((giraffeIndex) =>
  giraffeIndex.includes("giraffe")
);
